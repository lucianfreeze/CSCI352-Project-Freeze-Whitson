...
namespace Interface_Mockups {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsersRow AddUsersRow(string First, string Last, string Email, string Password) {
...
namespace Interface_Mockups.Database1DataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Users` WHERE ((`ID` = ?) AND ((? = 1 AND `First` IS NULL) OR (`First" +
                "` = ?)) AND ((? = 1 AND `Last` IS NULL) OR (`Last` = ?)) AND ((? = 1 AND `Email`" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`First`, `Last`, `Email`, `Password`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Users` SET `First` = ?, `Last` = ?, `Email` = ?, `Password` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `First` IS NULL) OR (`First` = ?)) AND ((? = 1 AND `Last` IS NULL) OR (`Last` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Interface_Mockups.Properties.Settings.Default.UsersConnection;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, [First], [Last], Email, [Password] FROM Users";
        ...
        public virtual int Delete(int Original_ID, string Original_First, string Original_Last, string Original_Email, string Original_Password) {
        ...
        public virtual int Insert(string First, string Last, string Email, string Password) {
            if ((First == null)) {
        ...
        public virtual int Update(string First, string Last, string Email, string Password, int Original_ID, string Original_First, string Original_Last, string Original_Email, string Original_Password) {
            if ((First == null)) {
